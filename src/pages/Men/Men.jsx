  ...
  return (
    <section className="pt-[250px] bg-white pb-[300px]">
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-16 gap-y-10">
        {data.map((singleData, i) => (
          ...
          >
            ...
            <div className="absolute bottom-[55px] left-0 right-0 top-0 bg-black/50 flex flex-col justify-center items-center text-white opacity-0 transition-opacity duration-500 hover:opacity-60 p-2"></div>
      ...
      <div className="flex flex-col justify-center text-center text-xs mt-36 gap-6">
        <p>20 of 1,402</p>
        <button className="outline outline-1 mx-auto px-6 md:px-[300px] py-3">
          View More
        </button>
      </div>
    </section>
